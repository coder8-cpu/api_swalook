# Generated by Django 4.1.9 on 2024-03-11 03:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_pending', models.BooleanField()),
                ('status_completed', models.BooleanField()),
                ('status_canceled', models.BooleanField()),
                ('date', models.DateField()),
                ('vendor_name', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
