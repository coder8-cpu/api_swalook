          ...
          {branch.map((branch, index) => (
            <div className="card" key={branch.id}>
              ...
              <div className="buttons">
                <button className="admin-button" onClick={() => navigate(`/${sname}/${branch.admin_url}/admin`)}>Admin</button>
                <button className="staff-button" onClick={() => navigate(`/${sname}/${branch.staff_url}/staff`)}>Staff</button>
              </div>
            </div>
          ))}
